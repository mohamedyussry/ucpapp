...
* **Image Generation Policy:** The AI MUST NOT use its internal `generate_image` tool or any other AI-based image generation tools to create assets, mockups, or icons. Instead, it should use existing project assets, standard icon libraries (like Material Icons or FontAwesome), or code-based solutions (like CustomPainter).
